const API_KEY  = '7bbc95b73e6296bd7d838f586baf2b46';
	...
	sectionFilme.innerHTML = `
		<div class="row">
			...
			<div class="col-lg-7">
				...
				<div class="row">
					<div class="col-12">
						<strong>Título Original: </strong><p>${filme.original_title} (${filme.original_language})</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12 filme-sinopse">
						<strong>Sinopse: </strong><p>${filme.overview}</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12 col-md-6">
						<strong>Gêneros: </strong><p>${generos.join(", ")}</p>
					</div>
					<div class="col-12 col-md-6">
						<strong>Data de Estreia: </strong><p>${estreia.toLocaleDateString()}</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12 col-md-6">
						<strong>Site: </strong><a href="<p>${filme.homepage}">${filme.homepage}</p></a>
					</div>
					<div class="col-12 col-md-6">
						<strong>Duração: </strong><p>${filme.runtime} minutos</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12 col-md-6">
						<strong>Orçamento: </strong>$<p>${filme.budget.toLocaleString()},00</p>
					</div>
					<div class="col-12 col-md-6">
						<strong>Receita: </strong>$<p>${filme.revenue.toLocaleString()},00</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12 col-md-6">
						<strong>Países de Produção: </strong><p>${paises.join(", ")}</p>
					</div>
					<div class="col-12 col-md-6">
						<strong>Idiomas Falados: </strong><p>${idiomas.join(", ")}</p>
					</div>
				</div>
